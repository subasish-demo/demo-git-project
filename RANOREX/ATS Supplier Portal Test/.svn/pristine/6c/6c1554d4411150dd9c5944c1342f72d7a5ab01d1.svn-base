...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The FilterDetailsByAssignee recording.
    /// </summary>
    [TestModule("e0bf6ae3-e7d9-4728-b2e6-39bb798ee23e", ModuleType.Recording, 1)]
    public partial class FilterDetailsByAssignee : ITestModule
    {
        /// <summary>
        ...
        static FilterDetailsByAssignee instance = new FilterDetailsByAssignee();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public FilterDetailsByAssignee()
        {
        }
        ...
        /// </summary>
        public static FilterDetailsByAssignee Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            SPCollection.ValidateAssignees();
            Delay.Milliseconds(0);
            
            Report.Screenshot(ReportLevel.Info, "User", "", repo.MainWindow.NavigationPanel.tabPageList, false, new RecordItemIndex(4));
